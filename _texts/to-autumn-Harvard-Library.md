---
layout: poem
title: "To Autumn - Harvard Library Draft (September 19–21, 1819)"
...
- {:.indent-6}And fill all furuits[^fn1] with sweetness to the core
- {:.indent-8}To swell the gourd, and plump the hazle shells
- {:.indent-2}With a white[^fn2] kernel; to set budding more
- {:.indent-4}And still more later flowers for the bees
- {:.indent-4}Until they think warm days will never cease
- {:.indent-8}For Summer has o'erbrimm'd their clammy cells—[^fn3][^fn4]
...
- {:.indent-4}Thy hair soft lifted by the winnowing wind[^fn5]
...
- ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎‎ ‎ ‎ ‎ ‎  ‎ ‎ ‎ ‎ ‎ ‎ <del>minutes while wam slumpers creep</del>[^fn6]
...
- {:.indent-4}And[^fn7] full grown Lambs loud bleat from hilly bourn,
...
- {:.indent-8}And[^fn7] Gather'd[^fn8] Swallows twiter in the Skies—[^fn9]
...
[^fn3]: In <i>Keats' Craftsmanship</i> (1933), M.R. Ridley suggests that this draft was written between September 19 and 21, 1819. On September 21, Keats copied the poem in a letter to Richard Woodhouse also <a href="https://joshuacheverecohen.github.io/to-autumn/texts/to-autumn-Woodhouse">reproduced here</a>. While this is the earliest draft of "To Autumn" that exists, the first and third stanzas may have been composed in an earlier, now lost, draft. Ridley believes that the Harvard Library draft may be the first appearance of the poem's second stanza which is significantly revised compared to the first and third. 

[^fn4]: The punctuation at the end of this line appears more like a ‿ in the manuscript. Gittings, Ridley, and Stillinger transcribe this mark as an em dash. 

[^fn5]: Stillinger: wind <i>made out of</i> wing

[^fn6]: The grouping of lines from "orr on a half reap'd..." to "minutes while wam slumpers creep" are X'd out in the manuscript.

[^fn7]: Stillinger: And <i>written over</i> The <i>(in both lines)</i>

[^fn8]: Stillinger: Gather'd <i>made out of</i> Gathering

[^fn9]: Helen Vendler, in “The Living Hand of Keats,” (<i>John Keats: Poetry Manuscripts at Harvard: A Facsimile Edition</i>, ed. Jack Stillinger, 1990), offers the following insight on Keats's manuscript line indentations: "As we look at the manuscript of <i>To Autumn</i> we see—among many other things—what is lost, formally, when penmanship yields to the printed page. In their printed versions, Keats's lingering eleven-line stanzas are set as a solid block with four single indentations (in lines 2, 4, 6, and 8) and two double indentations (in lines 7 and 11). The manuscript stanza, by contrast, shows something like a double oozing—a seeping inward and downward for seven lines (with a slight resistance in the third line), followed by a second draining, from lines 8 through 11." Stillinger, in his introduction to <i>John Keats: Poetry Manuscripts at Harvard: A Facsimile Edition</i> (1990), suggests that Keats "did not consider his own manuscripts to be the primary textual representations of his work" and relied on others (Charles Brown, Richard Woodhouse, his brother George Keats, and publisher John Taylor) to copy out fine versions for publication, at which point the original holographs were "demoted to the status of personal mementos, to be given away to friends." 
